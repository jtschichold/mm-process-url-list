        ...
        try {
            ...
            if (!inputs.inPlace) {
                ...
                if (inputs.initval) {
                    ...
                    try {
                        for (var _f = __asyncValues(urllist.read(inputs.initval)), _g; _g = yield _f.next(), !_g.done;) {
                            const iventry = _g.value;
                ...
                try {
                    for (var _h = __asyncValues(globber.globGenerator()), _j; _j = yield _h.next(), !_j.done;) {
                        const lpath = _j.value;
                        core.info(`Loading list from ${lpath}...`);
                        try {
                            for (var _k = (e_3 = void 0, __asyncValues(urllist.read(lpath))), _l; _l = yield _k.next(), !_l.done;) {
                                const nentry = _l.value;
                            ...
                            try {
                                if (_l && !_l.done && (_c = _k.return)) yield _c.call(_k);
                            }
                    ...
                    try {
                        if (_j && !_j.done && (_b = _h.return)) yield _b.call(_h);
                    }
                ...
                if (inputs.result) {
                    yield urllist.write(inputs.result, result);
                }
                if (inputs.delta) {
                    yield urllist.write(inputs.delta, delta);
                }
                ...
                const globber = yield glob.create(inputs.list, inputs.listGlobOptions);
                try {
                    for (var _m = __asyncValues(globber.globGenerator()), _o; _o = yield _m.next(), !_o.done;) {
                        const lpath = _o.value;
                        core.info(`Processing list from ${lpath}...`);
                        const currentList = [];
                        try {
                            for (var _p = (e_5 = void 0, __asyncValues(urllist.read(lpath))), _q; _q = yield _p.next(), !_q.done;) {
                                const nentry = _q.value;
                            ...
                            try {
                                if (_q && !_q.done && (_e = _p.return)) yield _e.call(_p);
                            }
                        ...
                        yield urllist.write(lpath, result);
                    }
                }
                catch (e_4_1) { e_4 = { error: e_4_1 }; }
                finally {
                    try {
                        if (_o && !_o.done && (_d = _m.return)) yield _d.call(_m);
                    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.filter = exports.collapse = exports.write = exports.read = void 0;
const core = __importStar(__webpack_require__(186));
const readline = __importStar(__webpack_require__(58));
const fs = __importStar(__webpack_require__(747));
